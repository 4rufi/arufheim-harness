...
- Hay features de múltiples scopes mezcladas en `.harness/feature_list.json`
...
- El scope de sesión vive solo en `.harness/progress/current.md`, no modifica `.harness/feature_list.json`
